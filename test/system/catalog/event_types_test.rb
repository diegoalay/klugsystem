...
class Catalog::EventTypesTest < ApplicationSystemTestCase
  setup do
    @catalog_event_type = catalog_event_types(:one)
  end

  test "visiting the index" do
    visit catalog_event_types_url
    assert_selector "h1", text: "Catalog/Event Types"
  end

  test "creating a Event type" do
    visit catalog_event_types_url
    click_on "New Catalog/Event Type"
