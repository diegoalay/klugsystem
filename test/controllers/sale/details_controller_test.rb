...
class Sale::DetailsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create sale_detail" do
    assert_difference('Sale::Detail.count') do
      post sale_details_url, params: { sale_detail: {  } }
    end

    assert_redirected_to sale_detail_url(Sale::Detail.last)
  end
  ...
  test "should update sale_detail" do
    patch sale_detail_url(@sale_detail), params: { sale_detail: {  } }
    assert_redirected_to sale_detail_url(@sale_detail)
  end

  test "should destroy sale_detail" do
    assert_difference('Sale::Detail.count', -1) do
