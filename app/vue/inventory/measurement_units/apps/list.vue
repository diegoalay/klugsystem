<script type="text/javascript">
    export default {
        ...
        methods: {
            ...
            show(measurement_unit){
                this.$router.push(this.url.inventory('measurement_units/:id', {id: measurement_unit.id}).toString(false))
            },
            deleteRecord(id){
                const url = this.url.inventory('measurement_units/:id', {id: id})
...
<template>
    <section>
        <component-header-list
            ...
            title-button-create="Agregar unidad de medida"
            :loading="loading"
            @reloadList="list"
        >
        </component-header-list>
