<script type="text/javascript">
    export default {
        ...
        methods: {
            ...
            show(provider){
                this.$router.push(this.url.purchases('providers/:id', {id: provider.id}).toString(false))
            },
            deleteRecord(id){
                const url = this.url.purchases('providers/:id', {id: id})
...
<template>
    <section>
        <component-header-list
            title="Proveedores"
            title-button-create="Agregar proveedor"
            :loading="loading"
            @reloadList="list"
        >
        </component-header-list>
