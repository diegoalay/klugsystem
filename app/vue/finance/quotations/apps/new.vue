<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            submitQuotationOrQuotation(event){
                if(event){
            ...
            isViewQuotationType(){
                return this.viewType === 'quotation'
            },
            ...
            getTotalQuotation(){
                return (parseFloat(this.getTotal() + parseFloat(this.quotation.shipping_costs) + this.getInterest())).toFixed(2)
            },

            getChange(){
                return (parseFloat(this.quotation.received_amount) - this.getTotalQuotation()).toFixed(2)
            },
            ...
            getTotalQuotationWithFormat(){
                return `Q ${this.getTotalQuotation()}`
            },
            ...
            // Setters
            setReceivedAmount(){
                this.$set(this.quotation, 'received_amount', this.getTotalQuotation())
            },

            // validators
            validateReceivedAmount(){
                if (this.quotation.received_amount <= this.getTotalQuotation()){
        ...
        watch: {
            payment_method(value){
                if (value.id) {
                    this.$set(this.quotation, 'payment_method_id', value.id)
                } else {
                    this.$set(this.quotation, 'payment_method_id', null)
                }
...
<template>
    <section>
        ...
        <component-header-form :title="'Cotizar'">
            <slot name="buttons">
                ...
                <b-button variant="outline-primary" class="mb-2" href="#finish-quotation">
                    ...
                    <b-form>
                        ...
                        <b-input-group>
                            ...
                            <b-form-input
                                ...
                                v-model="quotation.shipping_costs"
                            >
                            </b-form-input>
                        </b-input-group>
                        <hr>
                        ...
                        <b-input-group>
                            ...
                            <b-form-input
                                ...
                                v-model="quotation.received_amount"
                                :min="getTotalQuotation()"
                            >
                            </b-form-input>
                            <b-input-group-append>
                        ...
                        <b-row>
                            <b-col cols="6">
                                <b-button id="finish-quotation" block variant="primary" type="submit" @click.prevent="submitQuotationOrQuotation"> {{ 'Generar cotización' }} </b-button>
                            </b-col>
                            <b-col clas="total-value">
                                <b-form-input readonly class="text-right" :value="getTotalQuotationWithFormat()"> </b-form-input>
                            </b-col>
                        </b-row>
                    </b-form>
                </b-card>
