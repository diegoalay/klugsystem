...
export default {
    ...
    mounted(){
        this.storedData = this.storage.local('bill')
        ...
        submitSale(sale_type){
            ...
            this.http.post(url, form).then(result => {
                ...
                if (result.successful) {
                    this.$toast.success('Factura realizada exitosamente.')
...
<template>
    <section>
        <component-header-form title="Generar Factura">
            <slot name="buttons">
