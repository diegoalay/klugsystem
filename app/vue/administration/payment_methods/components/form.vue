...
export default {
    ...
    methods: {
        ...
        postForm(){
            const url = this.url.admin('payment_methods')
            const form = {
            ...
            this.http.post(url, form).then(result => {
                if (result.successful) {
                    ...
                    this.$router.push(this.url.admin('payment_methods/:id', { id: result.data.id }))
                } else {
        ...
        putForm(){
            const url = this.url.admin('payment_methods/:id', {id: this.payment_method.id})
            const form = {
                payment_method: this.payment_method
            }
        ...
        getOptions(){
            const url = this.url.admin('payment_methods/options')
