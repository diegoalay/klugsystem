<script type="text/javascript">
    export default {
        ...
        methods: {
            getOptions(){
                const url = this.url.pos('expeditures/index_options')
            ...
            show(expediture){
                this.$router.push(this.url.pos('expeditures/:id', {id: expediture.id}).toString(false))
            },
            deleteRecord(id){
                const url = this.url.pos('expeditures/:id', {id: id})
