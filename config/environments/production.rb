Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'https://klugsystem.com', 'klugsystem.com', 'http://klugsystem.com' ]

  # Force all access to the app over SSL, use Strict-Klugsystem-Security, and use secure cookies.
  ...
  # config.active_job.queue_name_prefix = "transport_production"
