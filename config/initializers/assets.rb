...
Rails.application.config.assets.precompile += %w( pilots.js )
Rails.application.config.assets.precompile += %w( expeditures.js )
Rails.application.config.assets.precompile += %w( destinations.js )
